              ...
              {conversations.map(conv => (
                ...
                >
                  <div className="relative">
                    <div className="w-12 h-12 rounded-full bg-primary-100 text-primary-700 flex items-center justify-center font-bold overflow-hidden shrink-0 relative">
        ...
        {activeConvId ? (
          <>
            ...
            <div className="p-4 border-b border-gray-100 bg-white flex items-center gap-3 shrink-0">
              ...
              <div className="w-10 h-10 rounded-full bg-primary-100 text-primary-700 flex items-center justify-center font-bold overflow-hidden relative">
