      ...
      <div className="max-w-[800px] mx-auto px-6">
        <div className="bg-white rounded-2xl p-8 md:p-12 shadow-sm border border-[#e8e8e4]">
          ...
          <div className="text-[15px] text-[#4a4a4a] leading-[1.8] flex flex-col gap-8">
            ...
            <div>
              <h2 className="text-[20px] font-[800] mb-[12px] text-[#1b5e38]">1. Données collectées</h2>
              <p>
            ...
            <div>
              <h2 className="text-[20px] font-[800] mb-[12px] text-[#1b5e38]">2. Utilisation des données</h2>
              <p>
            ...
            <div>
              <h2 className="text-[20px] font-[800] mb-[12px] text-[#1b5e38]">3. Partage des données</h2>
              <p>
            ...
            <div>
              <h2 className="text-[20px] font-[800] mb-[12px] text-[#1b5e38]">4. Vos droits</h2>
              <p>
            ...
            <div>
              <h2 className="text-[20px] font-[800] mb-[12px] text-[#1b5e38]">5. Sécurité</h2>
              <p>
            ...
            <div>
              <h2 className="text-[20px] font-[800] mb-[12px] text-[#1b5e38]">6. Cookies</h2>
              <p>
