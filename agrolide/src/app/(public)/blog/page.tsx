        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            <div className="w-full lg:w-1/4">
              <div className="bg-white p-6 rounded-xl shadow-sm border border-[var(--color-gris-clair)] sticky top-24">
                <h3 className="font-bold text-lg mb-4 text-gray-900 border-b pb-2">Catégories</h3>
                <ul className="space-y-2">
                  <li>
                    <Link 
                      href="/blog" 
                      className={`block py-2 px-3 rounded-md transition-colors ${!categoryParam ? 'bg-gray-100 font-semibold text-[var(--color-vert-principal)]' : 'text-gray-600 hover:bg-gray-50'}`}
                    >
                  ...
                  {categories.map((cat) => (
                    <li key={cat}>
                      <Link 
                        ...
                        className={`block py-2 px-3 rounded-md transition-colors ${categoryParam === cat ? 'bg-gray-100 font-semibold text-[var(--color-vert-principal)]' : 'text-gray-600 hover:bg-gray-50'}`}
                      >
                        {cat}
                      </Link>
                    </li>
              ...
              {!hasArticles ? (
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  ...
                  <div className="col-span-full text-center py-12">
                    <p className="text-xl text-[var(--color-gris-texte)]">Articles bientôt disponibles dans cette catégorie.</p>
                  </div>
                </div>
              ) : (
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
